...
public class XXX_ScoreCalcStructure {
	...
	public void applyScores(XXX_ScanMatrixItem item, double distance) {
	...
	public static ScoreItem createExpBonusApplyer(double score) {
		return new ScoreItem(XXX_Constants.EXPERIENCE_DISTANCE, score) {
			@Override
			public void applyScore(XXX_ScanMatrixItem item) {
	...
	public abstract static class ScoreItem {
		...
		public abstract void applyScore(XXX_ScanMatrixItem item);
	}
}

 ...
 */
public class XXX_Drawing_MainFrame extends JFrame {
	...
	public XXX_Drawing_MainFrame(double maxX, double maxY) throws HeadlessException {
		this.MAX_X = maxX;
		this.MAX_Y = maxY;
		...
		add(drawPanel = new XXX_Drawing_DrawPanel(MAX_X, MAX_Y), c);
		...
		add(textInfoPanel = new XXX_Drawing_TextInfoPanel(), c);
	...
	private void run() {
		XXX_Drawing_DrawingStrategy.getInstance().move(slider.getValue());
	}
	...
	public XXX_Drawing_DrawPanel getDrawPanel() {
		return drawPanel;
	}

	public XXX_Drawing_TextInfoPanel getTextInfoPanel() {

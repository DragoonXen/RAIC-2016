 ...
 */
public abstract class YYY_Constants {
	...
	public static double MOVE_SCAN_DIAGONAL_DISTANCE = YYY_FastMath.hypot(MOVE_SCAN_STEP, MOVE_SCAN_STEP);
	...
	public static double MOVE_ANGLE_EXPAND = Math.PI / 180. * 5.; // 2 degrees
	...
	public static YYY_SpawnPoint[] SPAWN_POINTS = new YYY_SpawnPoint[]{new YYY_SpawnPoint(3200, 800), new YYY_SpawnPoint(3000, 200), new YYY_SpawnPoint(3800,
																																						1000)};
	...
	private static YYY_TopLine topLine;
	private static YYY_MiddleLine middleLine;
	private static YYY_BottomLine bottomLine;
	private static YYY_BaseLine[] lines;
	...
	public static void init(Game game, Wizard self) {
		...
		YYY_Constants.game = game;
		topLine = new YYY_TopLine();
		middleLine = new YYY_MiddleLine();
		bottomLine = new YYY_BottomLine();
		lines = new YYY_BaseLine[]{topLine, middleLine, bottomLine};
	...
	public static YYY_BaseLine[] getLines() {
		return lines;
	}

	public static YYY_TopLine getTopLine() {
		return topLine;
	}

	public static YYY_MiddleLine getMiddleLine() {
		return middleLine;
	}
	...
	public static YYY_BaseLine getLine(LaneType laneType) {
		switch (laneType) {
			case TOP:
				return topLine;
			case MIDDLE:
	...
	public static YYY_BottomLine getBottomLine() {
		return bottomLine;
	}

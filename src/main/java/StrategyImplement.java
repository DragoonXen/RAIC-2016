...
////			int ticksToBonusSpawn = world.getTickCount() - 2500;
////			double distanceToBonusA = FastMath.hypot(self.getX() - 1200, self.getY() - 1200);
////			double distanceToBonusB = FastMath.hypot(self.getX() - 1200, self.getY() - 1200);

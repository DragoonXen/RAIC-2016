 ...
 */
public abstract class XXX_Constants {
	...
	public static double MOVE_SCAN_DIAGONAL_DISTANCE = XXX_FastMath.hypot(MOVE_SCAN_STEP, MOVE_SCAN_STEP);
	...
	public static XXX_SpawnPoint[] SPAWN_POINTS = new XXX_SpawnPoint[]{new XXX_SpawnPoint(3200, 800), new XXX_SpawnPoint(3000, 200), new XXX_SpawnPoint(3800,
																																						1000)};
	...
	private static XXX_TopLine topLine;
	private static XXX_MiddleLine middleLine;
	private static XXX_BottomLine bottomLine;
	private static XXX_BaseLine[] lines;
	...
	public static void init(Game game, Wizard self) {
		XXX_Constants.game = game;
		topLine = new XXX_TopLine();
		middleLine = new XXX_MiddleLine();
		bottomLine = new XXX_BottomLine();
		lines = new XXX_BaseLine[]{topLine, middleLine, bottomLine};
	...
	public static XXX_BaseLine[] getLines() {
		return lines;
	}

	public static XXX_TopLine getTopLine() {
		return topLine;
	}

	public static XXX_MiddleLine getMiddleLine() {
		return middleLine;
	}

	public static XXX_BaseLine getLine(LaneType laneType) {
		switch (laneType) {
			case TOP:
				return topLine;
			case MIDDLE:
	...
	public static XXX_BottomLine getBottomLine() {
		return bottomLine;
	}

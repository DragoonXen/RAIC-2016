 ...
 */
public class Drawing_MainFrame extends JFrame {
    ...
    public Drawing_MainFrame(double maxX, double maxY) throws HeadlessException {
        this.MAX_X = maxX;
        this.MAX_Y = maxY;
        ...
        add(drawPanel = new Drawing_DrawPanel(MAX_X, MAX_Y), c);
        ...
        add(textInfoPanel = new Drawing_TextInfoPanel(), c);
    ...
    private void run() {
        Drawing_DrawingStrategy.getInstance().move(slider.getValue());
    }
    ...
    public Drawing_DrawPanel getDrawPanel() {
        return drawPanel;
    }

    public Drawing_TextInfoPanel getTextInfoPanel() {
